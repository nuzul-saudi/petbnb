          ...
          renderItem={({ item }) => {
            ...
            return (
              <InboxRow
                ...
                unread={hasUnread}
                unreadLabel={t('mybookings.unread_indicator')}
                title={
                  item.listing
                    ? pickLocalized(
                ...
                pill={<StatusPill kind="booking" status={item.status} />}
                latestMessage={item.latest_message ?? null}
                trailing={
                  <Text style={[styles.rowTotal, { color: theme.accent }]}>
